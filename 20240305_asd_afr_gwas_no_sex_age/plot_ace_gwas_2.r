...
for (chr in 1:22) {
  ...
  result_file <- sprintf("/u/project/pasaniuc/afcarrol/Projects/20240305_asd_afr_gwas_no_sex_age/output_files_ace/ace_asd_afr_gwas_chr%d.ASD.glm.logistic", chr)
...
write.table(result_table, file = "ace_afr_asd_unre_gwas_prscs_nas.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)