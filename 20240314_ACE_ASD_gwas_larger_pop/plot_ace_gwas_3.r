...
for (chr in 1:22) {
  ...
  result_file <- sprintf("/u/home/a/afcarrol/project-pasaniuc/Projects/20240314_ACE_ASD_gwas_larger_pop/output_files_ace/ace_asd_afr_gwas_chr%d.ASD.glm.logistic", chr)
