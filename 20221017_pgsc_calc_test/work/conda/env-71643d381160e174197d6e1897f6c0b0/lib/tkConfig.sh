...
# installed.
TK_PREFIX='/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tk8.6.12/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/u/project/pasaniuc/afcarrol/Projects/20221017_pgs_calc_autism/work/conda/env-71643d381160e174197d6e1897f6c0b0/lib/libtkstub8.6.a'
