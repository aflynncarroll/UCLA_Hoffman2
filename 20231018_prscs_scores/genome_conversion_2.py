...
df_chrom_pos = pd.read_csv("/u/project/pasaniuc/afcarrol/Projects/20231018_prscs_scores/spark_gwas_cp.txt", sep="\t")

# Call the run function and store the result
result = run(df_chrom_pos, chain="/u/home/a/afcarrol/software/liftOver/chain_files/hg38ToHg19.over.chain.gz", bin_path="/u/home/a/afcarrol/software/liftOver/liftOver")
