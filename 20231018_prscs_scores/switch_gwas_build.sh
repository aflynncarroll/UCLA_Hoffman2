...
cd /u/home/a/afcarrol/project-pasaniuc/Projects/20231018_prscs_scores
...
def run(df_chrom_pos: pd.DataFrame, chain: str, verbose: bool = False, bin_path: str = "liftOver"):
...
run("/u/project/pasaniuc/afcarrol/Projects/20231018_prscs_scores/spark_gwas_cp.txt", chain = "/u/home/a/afcarrol/software/liftOver/chain_files/hg38ToHg19.over.chain.gz", bin_path = "liftOver_path_you_download/u/home/a/afcarrol/software/liftOver/liftOver") 