...
echo nextflow run pgscatalog/pgsc_calc -r v1.2.0 -profile conda --input /u/project/pasaniuc/afcarrol/Projects/20221020_pgsc_calc_autism/SPARK_full.csv --target_build GRCh38 --pgs_id PGS002453 --min_overlap 0.001 > command.txt
