...
#cd /u/home/a/afcarrol/project-pasaniuc/Projects/20240223_ACE_AFR_GWAS
...
for (chr in 1:22) {
  ...
  result_file <- sprintf("/u/home/a/afcarrol/project-pasaniuc/Projects/20240223_ACE_AFR_GWAS/output_files/ace_asd_afr_gwas_chr%d.ASD.glm.logistic", chr)
...
jpeg_file <- "manhattan_plot_ace_afr_asd.jpg"
...
jpeg(filename = "QQ_plot_ace_asd_unre.jpeg", width = 31, height = 31, units="cm", res=500, type="cairo")
...
write.table(result_table, file = "ace_afr_asd_unre_gwas_prscs.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)