...
#$ -N rfmix_spark
#$ -cwd
#$ -l h_data=200G,h_rt=16:00:00,highp
#$ -j y
#$ -o ./job_out
#$ -t 16-18
...
for chrom in {16..18}; do

pfile=/u/project/geschwind/shared/GenomicDatasets-processed/ACE-ANALYSIS/freeze0/SPARK/hm3/chr${chrom}
out_prefix=/u/home/a/afcarrol/project-pasaniuc/Projects/20240910_spark_global_rfmix/out/chr${chrom}
######
...
#mkdir -p /u/home/a/afcarrol/project-pasaniuc/Projects/16022022_ancestry/rfmix-lanc
  ...
  # Add your commands here to process each chromoso
plink2 --pfile ${pfile} \
    --chr ${chrom} \
    --output-chr 26 \
