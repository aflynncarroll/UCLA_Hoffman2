...
pfile=/u/home/a/afcarrol/project-pasaniuc/Projects/16022022_ancestry/pgen_files/chr${chrom}
out_prefix=/u/home/a/afcarrol/project-pasaniuc/Projects/16022022_ancestry/rfmix-lanc/chr${chrom}
...
awk '$2=="CEU" || $2=="YRI" || $2=="PEL" {print $1 "\t" $2}' ${REF_DIR}/out/metadata/sample_map.unrelated.tsv >${out_prefix}.tmp.sample_map.tsv
# run RFmix
${RFMIX} \
