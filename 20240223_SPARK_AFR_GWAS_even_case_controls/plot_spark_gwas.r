...
for (chr in 1:22) {
  ...
  result_file <- sprintf("/u/home/a/afcarrol/project-pasaniuc/Projects/20240223_SPARK_AFR_GWAS_even_case_controls/output_files/asd_afr_gwas_chr%d.ASD.glm.logistic", chr)
...
write.table(result_table, file = "spark_afr_asd_unre_gwas_prscs.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)