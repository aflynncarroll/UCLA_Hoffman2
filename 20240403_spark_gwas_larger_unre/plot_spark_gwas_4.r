...
for (chr in 1:22) {
  ...
  result_file <- sprintf("/u/home/a/afcarrol/project-pasaniuc/Projects/20240403_spark_gwas_larger_unre/output_files/asd_afr_gwas_chr%d.ASD.glm.logistic", chr)
...
jpeg_file <- "manhattan_plot_spark_afr_asd_4.jpg"
...
jpeg(filename = "QQ_plot_spark_asd_unre_4.jpeg", width = 31, height = 31, units="cm", res=500, type="cairo")
...
write.table(result_table, file = "spark_afr_asd_unre_gwas_4.txt", sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)